...
class UpdateRestaurantLocationUseCase extends UseCase<Restaurant, void> {
  final RestaurantRepository repository;
  UpdateRestaurantLocationUseCase(this.repository);

  @override
  Future<Either<Failure, Restaurant>> call(void params) async {
    return await repository.updateRestaurantLocation();
  }
}
